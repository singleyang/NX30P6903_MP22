...
#End If
    ...
    Private Sub AttachModel()
        ...
        v = New View(trbIsrcRegVal, pca_data_fields_enum_t.isrc_val)
        lblIsrcDetReg.Text = Model.Caption(pca_data_fields_enum_t.isrc_det)
        v = New View(trbIsrcDetReg, pca_data_fields_enum_t.isrc_det)
        lblVinDutyReg.Text = Model.Caption(pca_data_fields_enum_t.vin_duty)
        v = New View(trbVinDutyReg, pca_data_fields_enum_t.vin_duty)
